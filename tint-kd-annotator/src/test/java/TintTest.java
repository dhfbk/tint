...
//            LOGGER.info(sentenceText);
            ...
            prop.setProperty("keyphrase.max_keyword_length", "4");
            prop.setProperty("keyphrase.prefer_specific_concept", "MEDIUM");
            prop.setProperty("keyphrase.group_by", "NONE");
            prop.setProperty("keyphrase.update", "true");
            prop.setProperty("keyphrase.no_abstract", "false");
            prop.setProperty("keyphrase.skip_proper_noun", "true");
            prop.setProperty("keyphrase.skip_keyword_with_proper_noun", "true");
            prop.setProperty("keyphrase.skip_keyword_with_not_allowed_words", "true");
            prop.setProperty("customAnnotatorClass.keyphrase","eu.fbk.dh.tint.kd.annotator.DigiKdAnnotator");
