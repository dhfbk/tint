...
public class TintTest {
    ...
    public static void main(String[] args) {
        ...
        sentenceText = "Clinton in testa nei sondaggi dopo l’«assoluzione» dell’Fbi sull’uso di un server di posta privato quando era Segretario di stato. Quel che sarà sarà.";
...
//            pipeline.loadSerializers();
            pipeline.setProperty("annotators", "ita_toksent, pos, ita_morpho, ita_lemma, ner");
