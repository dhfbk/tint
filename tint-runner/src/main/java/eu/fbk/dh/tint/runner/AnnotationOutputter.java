...
public abstract class AnnotationOutputter {
    ...
    private static final AnnotationOutputter.Options DEFAULT_OPTIONS = new AnnotationOutputter.Options(); // IMPORTANT: must come after DEFAULT_CONSTITUENCY_TREE_PRINTER
    ...
    public abstract void print(Annotation doc, OutputStream target,
            AnnotationOutputter.Options options) throws
            IOException;
    ...
    public String print(Annotation ann, AnnotationOutputter.Options options)
            throws IOException {
